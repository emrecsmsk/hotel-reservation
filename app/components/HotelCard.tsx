...
const HotelCard: FC<HotelCardProps> = ({id, image, name, location, price, isFavorite, onPressFavorite }) => {
    return (
        <div className="bg-black m-2 h-[300px] relative overflow-hidden flex justify-center rounded-xl shadow-md">
            <Image src={image}
            ...
            <div className="absolute bottom-2 bg-opacity-60 bg-black rounded-lg w-[80%]" >
